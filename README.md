...
```
python ./convert_wiki_dump_to_plaintext.py <wiki-archive.bz2> [wiki-archive.txt.bz2]
```

This turns the XML + wikitext articles into plaintext. You'll get this:
```
John Daniel Runkle

John Daniel Runkle (October 11, 1822 <E2><80><93> July 8, 1902) was a U.S. educator and mathematician. He served as acting president of MIT from 1868 to 1870 and president between 1870 and 1878.
